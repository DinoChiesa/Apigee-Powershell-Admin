...
Function Deploy-EdgeApi {
    ...
    .EXAMPLE
        Deploy-EdgeApi -Name oauth2-pwd-cc -Environment test -Revision 8 -Params @{ override = true }

    .EXAMPLE
        Deploy-EdgeApi -Name oauth2-pwd-cc -Environment test -Revision 8 -Params @{ override = true; delay = 45 }
